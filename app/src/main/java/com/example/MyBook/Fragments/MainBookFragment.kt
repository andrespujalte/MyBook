...
class MainBookFragment : Fragment() {
    ...
    fun onFirstLoginCreateBooksItems(){
        ...
        bookDao?.insertBook(book)
        book = Book(11,"Barcelona Mayo De 1937","Guillamon Agustin","LIBROS DE ANARRES","9789871523320",getString(R.string.Categoria_Divulgacion_Cientifica),"https://contentv2.tap-commerce.com/cover/large/9789871523320_1.jpg?id_com=1113","")
        bookDao?.insertBook(book)
        book = Book(12,"Anarquismo Entre Rejas","Cardenas M","LIBROS DE ANARRES","9789871523337",getString(R.string.Categoria_Divulgacion_Cientifica),"https://contentv2.tap-commerce.com/cover/large/9789871523337_1.jpg?id_com=1113","")
        bookDao?.insertBook(book)
        book = Book(13,"La Peste , La Bestia Y El Monstruo","Most Johann","LIBROS DE ANARRES","9789871523221",getString(R.string.Categoria_Divulgacion_Cientifica),"https://contentv2.tap-commerce.com/cover/large/9789871523221_1.jpg?id_com=1113","")
        bookDao?.insertBook(book)
        book = Book(14,"A Cien Años De Revolucion Rusa","Mintz Frank","LIBROS DE ANARRES","9789871523276",getString(R.string.Categoria_Divulgacion_Cientifica),"https://contentv2.tap-commerce.com/cover/large/9789871523276_1.jpg?id_com=1113","")
        bookDao?.insertBook(book)
        book = Book(15,"Libertarias En America Del Su","Guzzo Cristina","LIBROS DE ANARRES","9789871523191",getString(R.string.Categoria_Divulgacion_Cientifica),"https://contentv2.tap-commerce.com/cover/large/9789876294799_1.jpg?id_com=1113","")
        bookDao?.insertBook(book)
